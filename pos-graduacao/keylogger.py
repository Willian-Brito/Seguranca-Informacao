...
#                                                                                            #
#   RENOMEAR: WinService.py                                                                  #
#                                                                                            #
# COMANDO: pyinstaller -F -w --clean WinService.py ou pyinstaller -w WinService.py --onefile #
#                                                                                            #
##############################################################################################
...
ldir = tempfile.gettempdir() #c:\users\willian\appdata\local\temp
window = None
data = ''
head = ''
dump = []
